...
<a class="update_btn" style="position: fixed ; z-index:100;" href="total_books.php">See All products</a>
  <div class="container_box">
    <form action="" method="POST" enctype="multipart/form-data">
      <h3>Add products To <a href="index.php"><span>SJCE BOOKMART </span><span></span></a></h3>
      <input type="text" name="bname" placeholder="Enter book Name" class="text_field ">
      <input type="text" name="btitle" placeholder="Enter  name" class="text_field">
      ...
      <input type="submit" value="Add Product" name="add_books" class="btn text_field">
    </form>
  </div>
